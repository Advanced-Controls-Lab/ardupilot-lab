...
const AP_Param::GroupInfo AP_MotorsMulticopter::var_info[] = {
    ...
    AP_GROUPINFO("DOUBLETEST",51,AP_MotorsMulticopter, _test, 30),
    // @Param: SPOOL_TIME
    ...
    // @Values : 1 to total number of motors of the drone
    // @User: Standart
    AP_GROUPINFO("Motor_num", 80, AP_MotorsMulticopter, _motor_num, 3),
